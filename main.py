...
# $50 ekvivalenti (taxminiy, til bo‘yicha ko‘rsatish)
DEP_AMOUNT = {
    "uz": "255 000 so‘m ($50)",
    "ru": "4 500 ₽ ($50)",
    "en": "$50",
...
T = {
    "uz": {
        ...
        "reg_ok": (
            ...
            "Signallarga kirish uchun kamida <b>255 000 so‘m ($50)</b> depozit qiling. 💳"
        ),
        "dep_need": (
            "🌐 <b>Signalga kirish uchun kamida 255 000 so‘m ($50) depozit qiling.</b>\n\n"
    ...
    "ru": {
        ...
        "reg_ok": (
            ...
            "Для доступа к сигналам внесите минимум <b>4 500 ₽ ($50)</b>. 💳"
        ),
        "dep_need": (
