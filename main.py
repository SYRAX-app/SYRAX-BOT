...
async def on_video(cq: CallbackQuery):
    ...
    caption = t(lang, "video", support=SUPPORT_URL)
    try:
        try:
        ...
        await cq.message.answer(caption, reply_markup=kb_back(lang))
    await cq.answer()
...
async def on_media_file_id(message: Message):
    """Admin rasm/video/gif yuborsa file_id qaytaradi (keyinroq kerak)."""
    ...
    if message.photo:
        ...
        kind, fid = "animation/gif", message.animation.file_id
